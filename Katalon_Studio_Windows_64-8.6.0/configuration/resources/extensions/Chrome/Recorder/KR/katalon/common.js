...
function getShadowRootElement(element, currentWindow) {
    var object = {}
    treeHTML(element, object, currentWindow);
    if (element.getRootNode() instanceof ShadowRoot) {
        object['shadow_root'] = getShadowRootElement(element.getRootNode().host, currentWindow);
    }
    return object;
}
...
function mapDOM(element, currentWindow) {
    ...
    treeObject = getShadowRootElement(element, currentWindow);
    return treeObject;
}
